...
namespace CostAllocationApp.BLL
{
    public class EmployeeAssignmentBLL
    {
        ...
        public List<ForecastAssignmentViewModel> GetManMonthForDifferenceByDepartments(string departmentId, string companyIds, int year)
        {
            List<ForecastAssignmentViewModel> forecastAssignments = employeeAssignmentDAL.GetEmployeesForecastByDepartments_Company(departmentId, companyIds, year);
            if (forecastAssignments.Count > 0)
            {
        ...
        {
            List<ForecastAssignmentViewModel> forecastAssignments = employeeAssignmentDAL.GetBudgetManmonthByIncharge(inchargeIds, companyIds, year);
            if (forecastAssignments.Count > 0)
            {
                foreach (var forecastAssignment in forecastAssignments)
                {
        ...
        public List<ForecastAssignmentViewModel> GetTotalManmonthForDifferenceByIncharge(string inchargeIds, string companyIds, int year)
        {
            List<ForecastAssignmentViewModel> forecastAssignments = employeeAssignmentDAL.GetCostByCompanyAndInchargeIds(inchargeIds, companyIds, year);
            if (forecastAssignments.Count > 0)
            {
                foreach (var forecastAssignment in forecastAssignments)
                {
        ...
        public List<ForecastAssignmentViewModel> GetCostByCompanyAndInchargeIds(string inchargeId, string companyIds, int year)
        {
            List<ForecastAssignmentViewModel> forecastAssignments = employeeAssignmentDAL.GetCostByCompanyAndInchargeIds(inchargeId, companyIds, year);
            if (forecastAssignments.Count > 0)
            {
                foreach (var forecastAssignment in forecastAssignments)
                {
