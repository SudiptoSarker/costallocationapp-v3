...
namespace CostAllocationApp.BLL
{
    public class TotalBLL
    {
        ...
        public List<SukeyQADto> GetTotalBudgetCostByDepartment(string companiIds, int departmentId, int year)
        {
            double _octHinsho = 0;
            double _novHinsho = 0;
            double _decHinsho = 0;
        ...
        public List<SukeyQADto> GetTotalBudgetCostByIncharge(string companiIds, int inchargeIds, int year)
        {
            double _octHinsho = 0;
            double _novHinsho = 0;
            double _decHinsho = 0;
            ...
            double rowTotal = 0;
            double firstSlot = 0;
            Department department = departmentBLL.GetDepartmentByDepartemntId(inchargeIds);
            SukeyQADto sukeyDto = new SukeyQADto();
            sukeyDto.DepartmentId = department.Id.ToString();
            sukeyDto.DependencyName = department.DepartmentName;
