                ...
                if (forecastAssignmentViewModels.Count > 0)
                {
                    using (var package = new ExcelPackage())
                    {
                        ...
                        foreach (var item in forecastAssignmentViewModels)
                        {
                            ...
                            {
                                List<ForecastDistributdViewModal>  forecastAssignmentViewModelsForQCPercentage= employeeAssignmentBLL.GetQCAssignemntsPercentage(item.Id);
                                if (forecastAssignmentViewModelsForQCPercentage.Count > 0)
                                {
                                    foreach(var qcItem in forecastAssignmentViewModelsForQCPercentage)
                                    {
                                        ...
                                        var octPOriginal = (Convert.ToDecimal(item.OctPoints) * qcItem.OctPercentage) / 100;
                                        var novPOriginal = (Convert.ToDecimal(item.NovPoints) * qcItem.NovPercentage) / 100;                                         
                                        var decPOriginal = (Convert.ToDecimal(item.DecPoints) * qcItem.DecPercentage) / 100;
                                        var janPOriginal = (Convert.ToDecimal(item.JanPoints) * qcItem.JanPercentage) / 100;
                                        var febPOriginal = (Convert.ToDecimal(item.FebPoints) * qcItem.FebPercentage) / 100;
                                        var marPOriginal = (Convert.ToDecimal(item.MarPoints) * qcItem.MarPercentage) / 100;
                                        var aprPOriginal = (Convert.ToDecimal(item.AprPoints) * qcItem.AprPercentage) / 100;
                                        var mayPOriginal = (Convert.ToDecimal(item.MayPoints) * qcItem.Maypercentage) / 100;
                                        var junPOriginal = (Convert.ToDecimal(item.JunPoints) * qcItem.JunPercentage) / 100;
                                        var julPOriginal = (Convert.ToDecimal(item.JulPoints) * qcItem.JulPercentage) / 100;
                                        var augPOriginal = (Convert.ToDecimal(item.AugPoints) * qcItem.AugPercentage) / 100;
                                        var sepPOriginal = (Convert.ToDecimal(item.SepPoints) * qcItem.SepPercentage) / 100;
                                        ...
                                        if (isAddRow)
                                        {
                                            ...
                                            distributedWorksheet.Cells["A" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["A" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);

                                            distributedWorksheet.Cells["B" + distributedCount].Value = departmentName;
                                            distributedWorksheet.Cells["B" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["B" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            ...
                                            distributedWorksheet.Cells["C" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["C" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["C" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["D" + distributedCount].Value = roleName;
                                            distributedWorksheet.Cells["D" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["D" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            ...
                                            distributedWorksheet.Cells["E" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["E" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            ...
                                            distributedWorksheet.Cells["F" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["F" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["F" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["G" + distributedCount].Value = remarks;
                                            distributedWorksheet.Cells["G" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["G" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            ...
                                            distributedWorksheet.Cells["H" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["H" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            ...
                                            distributedWorksheet.Cells["I" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["I" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            ...
                                            distributedWorksheet.Cells["J" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["J" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            ...
                                            distributedWorksheet.Cells["K" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["K" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["K" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["L" + distributedCount].Value = Convert.ToDecimal(novPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["L" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["L" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["L" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["M" + distributedCount].Value = Convert.ToDecimal(decPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["M" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["M" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["M" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["N" + distributedCount].Value = Convert.ToDecimal(janPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["N" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["N" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["N" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["O" + distributedCount].Value = Convert.ToDecimal(febPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["O" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["O" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["O" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["P" + distributedCount].Value = Convert.ToDecimal(marPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["P" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["P" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["P" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["Q" + distributedCount].Value = Convert.ToDecimal(aprPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["Q" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["Q" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["Q" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["R" + distributedCount].Value = Convert.ToDecimal(mayPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["R" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["R" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["R" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["S" + distributedCount].Value = Convert.ToDecimal(junPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["S" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["S" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["S" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["T" + distributedCount].Value = Convert.ToDecimal(julPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["T" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["T" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["T" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["U" + distributedCount].Value = Convert.ToDecimal(augPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["U" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["U" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["U" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["V" + distributedCount].Value = Convert.ToDecimal(sepPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["V" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["V" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Yellow);
                                            distributedWorksheet.Cells["V" + distributedCount].AutoFitColumns();
                                        }
                                        else if (isDeleteRow)
                                        {
                                            distributedWorksheet.Cells["A" + distributedCount].Value = sectionName;
                                            distributedWorksheet.Cells["A" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["A" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["A" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["B" + distributedCount].Value = departmentName;
                                            distributedWorksheet.Cells["B" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["B" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["B" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["C" + distributedCount].Value = inChargeName;
                                            distributedWorksheet.Cells["C" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["C" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["C" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["D" + distributedCount].Value = roleName;
                                            distributedWorksheet.Cells["D" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["D" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["D" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["E" + distributedCount].Value = explanationName;
                                            distributedWorksheet.Cells["E" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["E" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["E" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["F" + distributedCount].Value = employeeName;
                                            distributedWorksheet.Cells["F" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["F" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["F" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["G" + distributedCount].Value = remarks;
                                            distributedWorksheet.Cells["G" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["G" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["G" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["H" + distributedCount].Value = companyName;
                                            distributedWorksheet.Cells["H" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["H" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["H" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["I" + distributedCount].Value = gradePoints;
                                            distributedWorksheet.Cells["I" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["I" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["I" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["J" + distributedCount].Value = unitPrice;
                                            distributedWorksheet.Cells["J" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["J" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["J" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["K" + distributedCount].Value = Convert.ToDecimal(octPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["K" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["K" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["K" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["L" + distributedCount].Value = Convert.ToDecimal(novPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["L" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["L" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["L" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["M" + distributedCount].Value = Convert.ToDecimal(decPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["M" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["M" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["M" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["N" + distributedCount].Value = Convert.ToDecimal(janPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["N" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["N" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["N" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["O" + distributedCount].Value = Convert.ToDecimal(febPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["O" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["O" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["O" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["P" + distributedCount].Value = Convert.ToDecimal(marPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["P" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["P" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["P" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["Q" + distributedCount].Value = Convert.ToDecimal(aprPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["Q" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["Q" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["Q" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["R" + distributedCount].Value = Convert.ToDecimal(mayPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["R" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["R" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["R" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["S" + distributedCount].Value = Convert.ToDecimal(junPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["S" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["S" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["S" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["T" + distributedCount].Value = Convert.ToDecimal(julPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["T" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["T" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["T" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["U" + distributedCount].Value = Convert.ToDecimal(augPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["U" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["U" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["U" + distributedCount].AutoFitColumns();

                                            distributedWorksheet.Cells["V" + distributedCount].Value = Convert.ToDecimal(sepPOriginal).ToString("0.0");
                                            distributedWorksheet.Cells["V" + distributedCount].Style.Fill.PatternType = ExcelFillStyle.Solid;
                                            distributedWorksheet.Cells["V" + distributedCount].Style.Fill.BackgroundColor.SetColor(Color.Gray);
                                            distributedWorksheet.Cells["V" + distributedCount].AutoFitColumns();
                                        }
                                        else if (!string.IsNullOrEmpty(approvedCells))
                                        {
