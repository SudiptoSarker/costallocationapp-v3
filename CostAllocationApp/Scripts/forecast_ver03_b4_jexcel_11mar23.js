        ...
        $('#jspreadsheet').jspreadsheet({
            ...
            worksheets: [{
                ...
                columns: [
                    ...
                    { title: "Section Name", name: "SectionName" },
                    { title: "Department Name", name: "DepartmentName" },
                    { title: "Incharge Name", name: "InchargeName" },
                    { title: "Role Name", name: "RoleName" },
                    { title: "Explanation Name", name: "ExplanationName", width: 200 },
                    { title: "Company Name", name: "CompanyName" },
                    { title: "Grade", name: "GradePoint" },
                    { title: "Unit Price", name: "UnitPrice", type: "number", mask: "#,##0" },
                    {
                        title: "10",
                        type:"decimal",
                        name: "forecasts.0.Points"
                    },
                    {
                        title: "11",
                        type: "decimal",
                        name: "forecasts.1.Points"
                    },
                    {
                        title: "12",
                        type: "decimal",
                        name: "forecasts.2.Points"
                    },
                    {
                       title: "1",
                        type: "decimal",
                        name: "forecasts.3.Points"
                    },
                    {
                        title: "2",
                        type: "decimal",
                        name: "forecasts.4.Points"
                    },                    
                    {
                       title: "3",
                        type: "decimal",
                        name: "forecasts.5.Points"
                    },
                    {
                        title: "4",
                        type: "decimal",
                        name: "forecasts.6.Points"
                    },
                    {
                        title: "5",
                        type: "decimal",
                        name: "forecasts.7.Points"
                    },
                    {
                        title: "6",
                        type: "decimal",
                        name: "forecasts.8.Points"
                    },
                    {
                        title: "7",
                        type: "decimal",
                        name: "forecasts.9.Points"
                    },
                    {
                        title: "8",
                        type: "decimal",
                        name: "forecasts.10.Points"
                    },
                    {
                        title: "9",
                        type: "decimal",
                        name: "forecasts.11.Points"
                    },
                    {
                        title: "10",
                        type: "number",
                    ...
                    },
                    {
                        ...
                        readOnly: true,
                        mask: "#,##0",
                        name: "forecasts.2.Total"
                    },
                    {
                       title: "1",
                        type: "decimal",
                        readOnly: true,
                        name: "forecasts.3.Total"
                    },
                    {
                        title: "2",
                        type: "decimal",
                    ...
                    },                    
                    {
                        ...
                        readOnly: true,
                        mask: "#,##0",
                        name: "forecasts.5.Total"
                    },
                    {
                        title: "4",
                        type: "decimal",
                        readOnly: true,
                        name: "forecasts.6.Total"
                    },
                    {
                        title: "5",
                        type: "decimal",
                    ...
                    },
                    {
                        ...
                        readOnly: true,
                        mask: "#,##0",
                        name: "forecasts.8.Total"
                    },
                    {
                        title: "7",
                        type: "decimal",
                        readOnly: true,
                        name: "forecasts.9.Total"
                    },
                    {
                        title: "8",
                        type: "decimal",
                    ...
                    },
                    {
                        ...
                        readOnly: true,
                        mask: "#,##0",
                        name: "forecasts.11.Total"
                    }

                ]
                
            }],
            license: ''
        });

        //jspreadsheet.destroy($('#jspreadsheet'),true);
    });
