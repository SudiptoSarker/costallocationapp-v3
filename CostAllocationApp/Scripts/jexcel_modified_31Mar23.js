    ...
    var jexcel = (function(el, options) {
        ...
        var defaults = {
            ...
            text:{
                ...
                /***************************\                           
                 author:    sudipto sarker
                 date:      31st march,2023
                 purpose:   jexcel row modify
                \***************************/	
                //insertANewRowAfter: 'Insert a new row after',
                insertANewRowAfter: '要員を追加する (add emp.)',
                insertANewRowMemberAfter: '同じ要員を複製する (duplicate emp.)',                
                copy:  'コピー (copy)',
                paste: '貼り付け (paste)',
                saveAs: 'CSVで保存 (save)',
                about: 'このアプリについて (about)',                
                deleteSelectedRows: '選択した要員を削除 (delete)',
        ...
        */
         ...
         * @return void
         */
        obj.insertRowOfMember = function (mixed, columnData, rowNumber, insertBefore) {
            // Configuration
            if (obj.options.allowInsertRowOfMember == true) {
                // Records
                var records = [];
                ...
                // Events
                obj.dispatch('oninsertrowmember', el, rowNumber, numOfRows, columnData, insertBefore);
            }
        }
        ...
        if (options && options.contextMenu != null) {
            ...
            obj.options.contextMenu = function(el, x, y, e) {
                ...
                if (y == null) {
                    ...
                    if (obj.options.insertANewRowBefore) {
                        // Added by Sudipto --------------------------------------------------------------------------------------------
                        items.push({
                    ...
                    if (obj.options.allowInsertRowOfMember == true) {
                        items.push({
                            title: obj.options.text.insertANewRowMemberAfter,
                            onclick: function () {
                                obj.insertRowOfMember(0, obj.getColumnData(parseInt(1))[y], parseInt(y));  //0 of parseInt(0) should be changed. 0 means 1 column data.
                            }
                        });
                    }
