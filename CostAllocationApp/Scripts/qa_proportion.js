...
$(document).ready(function () {
    ...
    //employee wise and department wise modal close button clicked and close the modal
    $('.modal_return_btn').on('click', function () {
        $('#slect_employee_modal').modal('hide');
        $('#slect_department_modal').modal('hide');
    });

    //select employee from employee modal
    ...
    //select department from department modal
...
//show data in jexcel for employee wise proration
function ShowEmployeeWiseData() {
    ...
    jss = $('#jspreadsheet').jspreadsheet({
        ...
        columns: [
            ...
            { title: "要員名", type: 'text', name: "EmployeeName", width: 100 },
...
//show data in jexcel for department wise proration
function ShowDepartmentWiseData() {
    ...
    jss_1 = $('#jspreadsheet_1').jspreadsheet({
        ...
        columns: [
            ...
            { title: "部門名", type: 'text', name: "DepartmentName" },
...
//validate the department wise data
