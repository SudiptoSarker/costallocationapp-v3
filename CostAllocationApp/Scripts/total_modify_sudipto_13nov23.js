$(document).ready(function () {
    ...
    function GetAllDynamicTablesWithCalculation(selected_compannies,selected_year,timeStampId) {
        ...
        return strTotalTablesWithCalculationHtml;
    } 
    ...
    $('#show_dynamic_tables').on('click', () => {        
        ...
        if (selected_compannies == "" || selected_compannies == null || selected_compannies == undefined) {
            ...
            var totalTablesHtml = GetAllDynamicTablesWithCalculation(selected_compannies,selected_year,timeStampId);
            //totalTablesHtml = totalTablesHtml.replace('\t', '');
            $('#dynamic_tables').empty();
            $('#dynamic_tables').append(totalTablesHtml);
            return false;
